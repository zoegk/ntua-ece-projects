...
class Polynomial {
 ...
 public:
  ...
  Polynomial(const Polynomial &p): head(nullptr), degree(0), size(0) {kopi(p);};
  ~Polynomial() {efyge();}

  Polynomial & operator =(const Polynomial &p) {clear(); kopi(p); return *this;}
